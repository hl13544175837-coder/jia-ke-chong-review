...
assert.match(chat, /API_BASE/, 'Agent chat should reuse the configurable API base');
assert.match(chat, /\$\{API_BASE\}\/agent\/conversations\/\$\{id\}/, 'Agent chat should fetch conversation detail');

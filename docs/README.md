...
- 生产应用工厂不执行 DDL；空库显式 bootstrap，已有库 Alembic。当前 additive head 是 `20260726_09`（08 补齐试点审批/业务筛选 schema，09 新增候选人个人收藏和合并审计），Strict cutover、目标引擎恢复证据和 SIT 四角色现场验收仍属于环境发布门禁，不能由本地代码测试替代。

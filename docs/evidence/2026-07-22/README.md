...
> **历史预收口证据**：本目录记录功能候选固定前的阶段性验收，测试数量、Alembic head、演示库兼容数据和截图均不得作为最终口径。最终本地证据见 [`../2026-07-22-codex-final/README.md`](../2026-07-22-codex-final/README.md) 与 [`acceptance.json`](../2026-07-22-codex-final/acceptance.json)。
>

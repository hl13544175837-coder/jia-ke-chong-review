...
const backendBase = (process.env.LOCAL_OAUTH_BACKEND_BASE || 'http://127.0.0.1:5010/api').replace(/\/+$/, '');
const allowedOrigin = process.env.LOCAL_OAUTH_FRONTEND_ORIGIN || 'http://127.0.0.1:5190';
...
const accountEmails = new Map([
  ...
  ['interviewer02', 'interviewer02@mvp.local'],
  ['director01', 'director01@mvp.local'],
]);
...
server.listen(port, '127.0.0.1', () => {
  console.log(`Local OAuth bridge: http://127.0.0.1:${port}/pgs/oauth`);
